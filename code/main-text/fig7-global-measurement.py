...
Figure 7: Global-measurement-induced concentration for the fidelity kernel
...
sample = 60 #25
layer_tot = [1, 2, 4, 8, 10, 20] #, 50, 70, 100] #, 150, 200]#[2, 4, 8, 16, 32, 64, 128, 256]
...
elif name_embed == 'TPE_Rz':
    def layer_circuit(x_in, wires):
        """Building block of the embedding ansatz"""
        
        for i in range(len(wires)):
            qml.Hadamard(wires=i)
            qml.RZ(x_in[i], wires=i)   
